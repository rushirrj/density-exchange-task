...
const MasterLife = () => {
    return (
        <div className="px-20 ">
            <div style={{ height: "490px" }} className='bg-bgBlue rounded-3xl flex '>
                ...
                <div className='basis-1/2 flex items-center justify-center w-full'>
                    ...
                    <motion.div
                        ...
                        {/* red ghost */}
                        <motion.div animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ top: "45px" }} className='absolute h-16 w-12'><img className='h-full w-full' src="blue-ghost.png" alt="" /></motion.div>
                        {/* blue ghost */}
                        <motion.div animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ right: "-30px", top: "50%", transform: "translate(-50%,-50%)" }} className='absolute h-16 w-14'><img className='h-full w-full' src="red-ghost.png" alt="" /></motion.div>
                        {/* voilet ghost */}
                        <motion.div animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ bottom: "-22px", right: "50%" }} className='absolute h-14 w-12'><img className='h-full w-full' src="newGhost.png" alt="" /></motion.div>
                    </motion.div>
                </div>
